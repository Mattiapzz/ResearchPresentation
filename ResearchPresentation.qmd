...
:::{.notes}
Everithyng work right out of the box? No, for sure this is a perfect recipe for a disaster.
So, Idea...
Solve a similar problem more threatable (less complex), convex and quadratic.
...
$w_T = 1$ and $\mathbf{W_{qss}} = 0$.
Cyclic conditions (Initial and final conditions are the same).
Push the penality values on constraints.
...
## MLT Motorcyle {background-color="var(--secondary-color)"}

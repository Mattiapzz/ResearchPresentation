...
- **Curvilinear coordinates:** employ clothoid.
...
- **Quality** of the solution **highly** depends on the hardware.
  - $\sim200$ MP on dSPace Autera (Intel Xeon @ 2.0 GHz)
...
Future goals
:::
- Introduce **learning** of planner parameters for MCTS
- Specialize MCTS planner with different primitives.
- Use our framework for MPC initialization.
- Complete the analysis of motorcycle optimal control with telemetry data.
:::
...
## Sampling based initialization of MPC {.unnumbered .unlisted}
...
## MLT for MotoGP {background-image="data/MLT/Moto/bikestraigth_flank.png" background-opacity="0.05" .unnumbered .unlisted}
...
## MLT Motorcycle {.unnumbered .unlisted}

...
<!-- ## VeDi2025 and SUNRISE Goals {.hidden}
...
:::
- Sistematically reliable initial guess.
...
Core idea
:::
- Perform a rapid exporation with ad-hoc motion primitives (i.e. MP able to satify the MPC constraints).
